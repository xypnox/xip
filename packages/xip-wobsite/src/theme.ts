...
const base = {
  ...
  font: {
    family: '"Isoso Web", sans-serif',
    heading: '"Isoso Web", serif',
    mono: '"Isoso Web", monospace',
...
const vars = {
  ...
  dark: {
    primary: "oklch(65% 0.15 330)",
    background: "oklch(18% 0.019 274.65)",
    text: "oklch(75% 0.07 240)",
  },
};
